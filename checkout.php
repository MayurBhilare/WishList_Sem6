                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="order-details__item">
								...
								$qty=$val['qty'];
								$cost=$cart_total=$cart_total+($price*$qty);
								$gst_amt=$cart_total*$gst;
								$total_amt=$cart_total+$gst_amt;
                            ...
                            <div class="ordre-details__total">
															<table style=" width:300px;height:250px;">
															  ...
															  <td><span class="price" ><?php echo $cost?></span></td>
															</tr>
															<tr style="border-bottom:1px solid grey;">
																<td><br><h5>12% GST</h5></td>
																<td><span class="price"><?php echo $gst_amt?></span></td>
															</tr>
															<tr style="border-bottom:1px solid grey;">
																<td><h5>Order total</h5></td>
                                <td><span class="price"><?php echo $total_amt?></span></td>
															</tr>
															</table>
                            </div>
                        </div>
