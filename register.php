							...
							<div class="col-xs-12">
								...
								<form id="register-form" method="post">
									<div class="single-contact-form">
										...
										<div class="contact-box name">
											<input type="text" name="name" id="name" placeholder="Your Email*" style="width:100%">
										</div>
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="user_register()" disabled id="btn_register"><a href="login.php">Register</a></button>
									</div>
								</form>
